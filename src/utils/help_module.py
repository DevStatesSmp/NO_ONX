...
\033[94mOptions:\033[0m
  ...
  \033[93m--clear_cache\033[0m (-cc)      - Clear Python cache files

\033[94mCommands Group:\033[0m
    \033[96mfileinfo\033[0m      - File and directory information
    \033[96mmodify\033[0m        - Modify file or directory attributes      
    \033[96mcompare\033[0m       - Compare files or directories
    \033[96mbackup\033[0m        - Backup and restore files/directories
    \033[96mmonitoring\033[0m    - System and file monitoring
    \033[96mscanning\033[0m      - Scan files or directories for malware   
    \033[96msandbox\033[0m       - Run file in sandbox (NNX PRIVATE)
    \033[96mfeature\033[0m       - Toggle feature flags

    For detailed usage: nnx --help <group>      
""")
...
\033[94mScanning tools commands:\033[0m
""")          

def help_feature():
    print("""
\033[94mUsage:\033[0m
  \033[92m1.\033[0m nnx --config <FEATURE_NAME> true/false

\033[94mOptions:\033[0m
    NNX_SHELL                       - Enable or disable the NNX Shell
    NNX_SHELL_PRIV                  - Enable or disable the NNX Private Shell
    ENABLE_EXPERIMENTAL_COMMANDS    - Enable or disable experimental commands
    ENABLE_INTERNAL_COMMANDS        - Enable or disable internal commands
    ENABLE_NNX_COMMANDS             - Enable or disable NNX commands
    HIDDEN_BANNER                   - Enable or disable hide the banner when running version command
    DISABLE_LOADING                 - Enable or disable loading
    DISABLE_PLUGIN                  - Enable or disable plugin system
""")
...
\033[94mOptions:\033[0m
  \033[93m--version\033[0m (-v)           - Show version information
  \033[93m--help\033[0m (-h)              - Show help
  \033[93m--system_info\033[0m (-si)      - Show system informationa          
  \033[93m--clear_cache\033[0m (-cc)      - Clear Python cache files
